...
from app.routers import sat_search, health, ocr, assistant
...
app = FastAPI(
    ...
    description="Multilingual semantic search for SAT product/service codes, Receipt OCR, and Tax Assistant",
    version="1.2.0",
    lifespan=lifespan,
)
