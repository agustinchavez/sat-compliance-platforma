...
export function CustomerForm({ customer, taxRegimes, cfdiUses, onCancel, onSuccess }: CustomerFormProps) {
  ...
  // Determine RFC type for filtering tax regimes
  const rfcType = rfc.length === 12 ? 'legal_entity' : rfc.length === 13 ? 'individual' : null
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              required
              maxLength={13}
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono uppercase"
              placeholder="XAXX010101AAA"
            />
            {rfcType && (
              <p className="mt-1 text-xs text-gray-500">
                {rfcType === 'legal_entity' ? 'Persona Moral (12 chars)' : 'Persona Física (13 chars)'}
              </p>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              id="cfdi_use"
              name="cfdi_use"
              defaultValue={customer?.cfdi_use || 'G03'}
              required
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
